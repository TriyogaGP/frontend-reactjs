		...
		<div>
			<aside className="main-sidebar sidebar-dark-primary elevation-4">
				<Link to='/dashboard' className="brand-link">
					...
					<span className="brand-text font-weight-light">APLIKASI</span>
				</Link>
				<div className="sidebar">
					<div className="user-panel mt-3 pb-3 mb-3 d-flex">
						<div className="image">
							<img src={gbr} className="img-circle elevation-2" alt="User Image" />
						</div>
						<div className="info" style={{fontSize: 12}}>
							<Link to='/profile' className="d-block">{props.namaLengkap}</Link>
						</div>
					</div>
									...
									<ul className="nav nav-treeview">
										<li className="nav-item">
											...
											<ul className="nav nav-treeview">
												...
												<li className="nav-item">
													<Link to="/pengguna?page=dosen" className="nav-link">
														<i className="far fa-user nav-icon" />
														<p> Dosen</p>
													</Link>
												</li>
												<li className="nav-item">
													<Link to="/pengguna?page=asistendosen" className="nav-link">
														<i className="far fa-user nav-icon" />
														<p> Asisten Dosen</p>
													</Link>
												</li>
												<li className="nav-item">
													<Link to="/pengguna?page=mahasiswa" className="nav-link">
														<i className="far fa-user nav-icon" />
														<p> Mahasiswa</p>
													</Link>
												</li>
										...
										<li className="nav-item">
											...
											<ul className="nav nav-treeview">
												<li className="nav-item">
													<Link to="/bootcamp" className="nav-link">
